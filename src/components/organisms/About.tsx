...
const features = [
  ...
  },
  {
    ...
    title: "Collaboration",
    description:
      "Working effectively in teams to deliver high-quality projects on time.",
  },
];
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            >
              ...
              <Typography variant="body1" color="text.secondary" paragraph>
                ...
                building web applications. My journey in tech started with a
                curiosity about how things work, which evolved into a passion
                for creating seamless digital experiences.
              </Typography>

              <Typography variant="body1" color="text.secondary" paragraph>
                I specialize in modern web technologies including React,
                TypeScript, and cloud platforms. I believe in writing
